    ...
    <MaxWidthWrapper className="pt-16">
      <div className="max-h-screen relative">
        <div className="flex flex-col items-center">
          <p className="text-6xl leading-[72px] font-sofia_pro text-center font-bold">
            Launch your own <br /> eCommerce store with Dropify
          </p>
          <p className="font-dm_Sans text-center mt-4 font-[400] max-w-[808px] text-2xl leading-[43px]">
            In just a few clicks and Maximise your ROI with 500%+. Create your
            own store without prior experience in programming
          </p>
          <form className="max-w-[546px] w-full  mt-4">
            ...
            <div className="relative z-20 mb-6 lg:m-0 h-[74px] ">
              <input
                type="search"
                className="block lg:text-2xl text-base rounded-[74px] text-[#001829] max-w-[546px] lg:h-[68px] h-[58px] w-full p-4 pl-8 border bg-gray-50 duration-100 outline-none focus:outline-none focus:border-2 border-[#001829] "
                placeholder="Enter Your Email Address"
              />
              {/* <button type="submit" className="text-white absolute end-2.5 bottom-2.5 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Search</button> */}
              <Button className="rounded-[34px] font-Gilroy font-bold lg:w-[188px] lg:h-[57px]  h-[47px]  absolute top-1.5 right-1.5 flex items-center gap-[3px] lg:text-xl text-lg  bg-[#0095fb]">
                Get Started{" "}
                <Image
                  width={17}
                  height={17}
